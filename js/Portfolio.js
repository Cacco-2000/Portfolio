...
btnHtmlCss.addEventListener("click", () =>
  handleButtonClick(btnHtmlCss, "html-css")
);
btnHtmlCssJs.addEventListener("click", () =>
  handleButtonClick(btnHtmlCssJs, "html-css-js")
);
...
const translation = {
  it: {
    ...
    "github-link": "Profilo Github con tutti i progetti più recenti",
    ...
    "project-8": "Telephone Number Validator",
    "project-link-8": "Visita il progetto",
    "project-9": "Cash Register",
  ...
  en: {
    ...
    "github-link": "Github Profile with all the most recent projects",
    ...
    "project-11": "Personal Page",
    "project-link-11": "Visit the project",
...
const cambiaLingua = (lingua) => {
  ...
  document.getElementById("nome").placeholder =
    translation[lingua]["name-placeholder"];
  document.getElementById("email").placeholder =
    translation[lingua]["email-placeholder"];
  document.getElementById("oggetto").placeholder =
    translation[lingua]["object-placeholder"];
  document.getElementById("messaggio").placeholder =
    translation[lingua]["message-placeholder"];
...
const aggiornaTestoTema = () => {
  const temaCorrente = themeLink
    .getAttribute("href")
    .includes("css/TemaChiaro.css");

  temaBottone.setAttribute(
    "data-translate",
    temaCorrente ? "button-theme-dark" : "button-theme-light"
  );

  temaBottone.innerHTML =
    translation[currentLang][temaBottone.getAttribute("data-translate")];
};
